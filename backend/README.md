...
## Project Structure
    ...
    ├── free_throw_challeng_38026  # Django project configurations
...
1. Clone this repo and `cd free_throw_challeng_38026`
...
2. Clone this repo and `cd free_throw_challeng_38026`
